...
<div style="width: 100%;">
   ...
   <div style="float:right; width:74%">
			...
			<p>Author Home: <a href="<s:property value="%{#request.current_select_post.authorHomePageURL}"/>" target="_blank"> <s:property value="#request.current_select_post.authorHomePageURL"/> </a></p>
			</s:if>
			<s:if test='#request.current_select_post.forumURL.equals("") == false'>
			<p>Discussing Forum: <a href="<s:property value="%{#request.current_select_post.forumURL}"/>" target="_blank"> <s:property value="#request.current_select_post.forumURL"/> </a></p>
			<%-- <p>Discussing Forum: <a href="<s:property value="#request.current_select_post.forumURL}"/>" target="_blank"> <s:property value="#request.current_select_post.forumURL"/> </a></p> --%>
			</s:if>
