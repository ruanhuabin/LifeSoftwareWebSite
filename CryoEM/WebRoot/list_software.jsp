...
<div style="width: 100%;">
   ...
   <div style="float:right; width:74%">
   		<s:iterator value="#request.all_post" id="allPost">
			<h2><a id=<s:property value="#allPost.pid"/>></a><s:property value="#allPost.title"/> </h2>
			<p>
				<s:text name="%{#allPost.description}"/>
			</p>
			 <p><font size="5px">Download it,  please click &nbsp;<a href="<%=hostPort%><s:property value="#allPost.softwareURI"/>">Here.</a></font></p>
		</s:iterator>
